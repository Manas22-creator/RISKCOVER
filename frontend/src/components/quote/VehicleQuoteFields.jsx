// src/components/quote/VehicleQuoteFields.jsx
import React from 'react';
import './QuoteForm.css';

const VehicleQuoteFields = ({ values, handleChange, errors }) => {
  return (
    <>
      <div className="form-group full-width">
        <label htmlFor="vehicleNumber">Vehicle Number *</label>
        <input type="text" id="vehicleNumber" name="vehicleNumber" value={values.vehicleNumber} onChange={handleChange('vehicleNumber')} required />
...
export default VehicleQuoteFields;