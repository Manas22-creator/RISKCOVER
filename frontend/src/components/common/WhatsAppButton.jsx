...
// // SVG icon for WhatsApp — inlined SVG you provided (converted to JSX)
const WhatsAppIcon = () => (
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" focusable="false" style={{ display: 'block', width: '44px', height: '44px' }}>
