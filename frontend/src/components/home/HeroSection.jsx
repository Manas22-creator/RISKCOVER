      ...
      <div className="container hero-container">
        ...
        <div className="hero-content">
          <h1> Your Trusted
            ...
            for Every Vehicle & Need</h1>
          {/* <p>Comprehensive coverage for cars, bikes, trucks, and fleets. Get instant quotes and secure your vehicle today.</p> */}
          <p>
            We facilitate insurance from top providers like Reliance, Digit & Tata for cars, bikes, trucks, commercial vehicles, health, and life. Get the best quotes today.
          </p>
